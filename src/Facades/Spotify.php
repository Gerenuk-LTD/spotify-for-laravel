 ...
 * @method static SpotifyRequest searchItems(array|string $type, string $query)
 * @method static SpotifyRequest searchAlbums(string $query)
 * @method static SpotifyRequest searchArtists(string $query)
 * @method static SpotifyRequest searchPlaylists(string $query)
 * @method static SpotifyRequest searchTracks(string $query)
 * @method static SpotifyRequest searchShows(string $query)
 * @method static SpotifyRequest searchEpisodes(string $query)
 * @method static SpotifyRequest searchAudiobooks(string $query)
